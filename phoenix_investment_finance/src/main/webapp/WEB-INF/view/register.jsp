...
<div class="container">
	<div class="row">
		<h3>Investor/Client Registration</h3>
	</div>
	<br>
	<div class="row">
		<div class="col-md-5">
			...
			<table class="table table-bordered table-striped">
				<tbody>
					...
					<tr>
						...
						<td class="money">R<%=MoneyFormatter.format(propertyBondForecast.getBondRegistrationFee())%></td>
					</tr>
					<tr>
						<td class="money"><b>Legal Fees</b></td>
						<td class="money">R<%=MoneyFormatter.format(propertyBondForecast.getLegalFees())%></td>
					</tr>
					<tr>
						<td class="money"><b>Transfer Duty</b></td>
						<td class="money">R<%=MoneyFormatter.format(propertyBondForecast.getTransferDuty())%></td>
					</tr>
